export const string = {
  ...
  ProductDetailPage: {
    lessDescription:
      'Experience unparalleled power with the Honda EU70is Portable Generator. Its robust 4-stroke GX390 engine, coupled with advanced Electronic Fuelasds...',
    moreDescription:
    ...
    alertDescription:
      'Due to continuous improvement in product on the basis of market feedback above specification are subject to change with out any prior notice. Please contact authorized dealer/distributor for latest specification.',
  },
};
